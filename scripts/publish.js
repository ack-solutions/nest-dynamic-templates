...
const PACKAGE_PATH = path.join(__dirname, "../packages/nest-dynamic-templates/package.json");
...
function updateVersion(versionType) {
  ...
  console.log(`✅ Updated @ackplus/nest-dynamic-templates from ${oldVersion} to ${newVersion}\n`);
...
async function main() {
  try {
    ...
    if (success) {
      ...
      console.log(`📦 https://www.npmjs.com/package/@ackplus/nest-dynamic-templates/v/${versionInfo.newVersion}`);
      console.log(`\n📥 Install with:`);
      console.log(`   npm install @ackplus/nest-dynamic-templates@${versionInfo.newVersion}`);
      console.log(`   pnpm add @ackplus/nest-dynamic-templates@${versionInfo.newVersion}\n`);
    }
